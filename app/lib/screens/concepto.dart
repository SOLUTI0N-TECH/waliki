  ...
  Widget build(BuildContext context) => _screen(
        ...
        [
          Center(
            child: Container(
              ...
              decoration: const BoxDecoration(
                  shape: BoxShape.circle, color: Color(0xFFE7F4EC)),
              child: const Icon(Icons.fingerprint, size: 62, color: kGreen),
            ),
          ),
          const SizedBox(height: 14),
          const Center(
            child: Text('Crea tu billetera en 1 minuto',
          ...
          WCard(
            child: Column(
              children: const [
                _Bullet(Icons.lock_outline, 'Passkey y biometría — nada que memorizar'),
                SizedBox(height: 10),
                _Bullet(Icons.shield_outlined,
                    'Las llaves son solo tuyas — Waliki nunca custodia'),
                SizedBox(height: 10),
                _Bullet(Icons.restart_alt, 'Recuperación con la cuenta de tu teléfono'),
              ],
            ),
          ),
          const SizedBox(height: 12),
          PrimaryButton('Crear mi billetera',
              onTap: () => _concepto(context, 'Fase 2')),
          const SizedBox(height: 20),
          const Text('COMPRAR SALDO',
              style: TextStyle(
                  color: kMuted,
                  fontSize: 11,
          ...
          WCard(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text('Bs 200,00',
                    style: TextStyle(fontSize: 26, fontWeight: FontWeight.w700)),
                const Text('recibes ≈ 14,07 USDT · comisión de rampa 1,5%',
  ...
  Widget build(BuildContext context) => _screen(
        ...
        [
          GridView.count(
            ...
            children: [
              _Product('Salteña de pollo', 'Bs 10,00', Icons.bakery_dining_outlined,
                  const Color(0xFFF3E8D9), () => _concepto(context, 'Fase 3')),
              _Product('Café americano', 'Bs 12,00', Icons.coffee_outlined,
                  const Color(0xFFE7EEF6), () => _concepto(context, 'Fase 3')),
              _Product('Jugo de maracuyá', 'Bs 15,00', Icons.local_drink_outlined,
                  const Color(0xFFFBEFDD), () => _concepto(context, 'Fase 3')),
              _Product('Sándwich de chola', 'Bs 25,00', Icons.lunch_dining_outlined,
                  const Color(0xFFEAF3EE), () => _concepto(context, 'Fase 3')),
            ],
          ),
          const SizedBox(height: 16),
          const Text('PEDIDO #P-0456 · EN CAMINO',
              style: TextStyle(
                  color: kMuted,
                  fontSize: 11,
                  fontWeight: FontWeight.w700,
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                const _SplitRow('El cliente pagó', 'Bs 43,86 · 3,13 USDT', bold: true),
              ],
            ),
          ),
          const SizedBox(height: 8),
...
class PuntajeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => _screen(
        ...
        [
          ...
          const SizedBox(height: 8),
          const Center(
            child: Text('Sobre 1.240 ventas verificadas on-chain — auditable por cualquiera.',
          ...
          Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text('Adelanto de ventas disponible',
                    style: TextStyle(
                        fontWeight: FontWeight.w700, color: kGreenDark)),
                const Text('hasta Bs 3.500,00',
                    style: TextStyle(
                        fontSize: 28,
                        fontWeight: FontWeight.w700,
                        color: kGreenDark)),
                ...
                const SizedBox(height: 10),
                PrimaryButton('Simular adelanto',
...
class _MethodBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Material(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: BorderSide(
              color: selected ? kGreen : kLine, width: selected ? 2 : 1),
        ),
        child: InkWell(
          borderRadius: BorderRadius.circular(14),
          onTap: onTap,
